  ...
  return (
    <div className="main-container">
      ...
      <div className="hospital-info-content">
        ...
        <div className="image-tetris dimmed">
        ...
        <div className="hospital-info-overlay">
          ...
          <h1 className="highlight">
            HOSPIN 치과 병원은 당신의 건강한 미소를 약속합니다.
          </h1>
          <hr />
          <p>
            HOSPIN 치과 병원은 환자 중심의 진료 철학을 바탕으로,
            편안하고 신뢰할 수 있는 의료 환경을 제공합니다. 최신 의료 장비와
            첨단 기술을 바탕으로, 환자 한 분 한 분의 건강한 미소를 지키기 위해
            노력하고 있습니다.
          </p>
          <p>
            일반 치과 진료는 물론, 교정, 임플란트, 치주 치료 등 다양한 전문
            과목을 갖추고 있으며, 각 분야의 숙련된 전문의들이 유기적으로
            협력하여 환자에게 가장 적합한 맞춤형 치료 계획을 제안합니다.
          </p>
          <p>
            저희의 목표는 단순한 치아 치료를 넘어, 환자의 전반적인 구강 건강과
            삶의 질을 향상시키는 데 있습니다. HOSPIN 치과는 치료의 전 과정에서
            환자와의 소통을 중시하며, 따뜻하고 세심한 진료를 통해 신뢰와 안정을
            드리는 병원이 되고자 합니다.
          </p>
          <p>
            여러분의 건강한 내일을 위한 든든한 파트너, <br />
            HOSPIN 치과 병원입니다.
          </p>
        </div>
      </div>
